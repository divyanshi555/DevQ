    ...
    <>
      <div className="bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="shrink-0 h-10 px-5 bg-linear-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-600 text-sm text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-90"
              >
          ...
          {/*Explain Concept */}
          <div className='group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shmd transition-all duration-200'>
            <form onSubmit={handleExplainConcept}>
              ...
              <div className='flex items-center gap-3'>
                <input
                  ...
                  placeholder='e.g. JK Flip Flop'
                  className='flex-1 h-11 px-4 border-2 border-r-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-purple-50/10'
