...
const ChatInterface = () => {
  ...
  return (
    <div className='flex flex-col h-[70h] bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden'>
          ...
          <div className='flex items-center gap-3 my-4'>
            ...
            <div className='flex items-center gap-2 px-4 py-3 rounded-2xl rounded-bl-md bg-white border border-slate-200/60'>
              <div className='flex gap-1'>
                ...
                <span className='w-2 h-2 bg-slate-200 rounded-full animate-bounce' style={{animationDelay:'150ms'}}></span>
                <span className='w-2 h-2 bg-slate-200 rounded-full animate-bounce' style={{animationDelay:'300ms'}}></span>
              </div>
            </div>
          </div>
        )}
      ...
      {/*Input Area */}
      <div className=' p-5 border-t bprder-slate-200/60 bg-white/80'>
